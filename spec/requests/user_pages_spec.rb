...
describe "UserPages" do
  ...
  describe "user index page" do
    ...
    after(:all)  {User.delete_all} #doesn't invoke callbacks on destroy !
  ...
  describe "Profile page" do
    let (:user) { FactoryGirl.create(:user) }
    let!(:m1) { FactoryGirl.create(:micropost, user: user, content: "Foo1" ) }
    let!(:m2) { FactoryGirl.create(:micropost, user: user, content: "Bar2" ) }
    ...
    describe "follow/unfollow button" do
      ...
      describe "follow a user" do
        ...
        describe "should change the button to unfollow text" do
  ...
  describe "following/follwers" do
    ...
    describe "followers" do
      ...
      it { should have_selector('h3', text: 'Followers') } # might be too much depth
